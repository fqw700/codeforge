...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/YOUR_ORG/codeforge/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for YOUR_ORG/codeforge...\n")
...
console.log("Fetching npm all-time downloads for codeforge-ai...\n")
const npmDownloads = await fetchNpmDownloads("codeforge-ai")

...
Use this folder for locale-specific translation guidance that supplements `.codeforge/agent/translator.md`.
...
- PR #12345: https://github.com/YOUR_ORG/codeforge/pull/12345

## Do Not Translate (Locale Additions)

- `CodeForge` (preserve casing)

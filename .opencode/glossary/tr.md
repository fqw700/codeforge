...
- PR #15835: https://github.com/YOUR_ORG/codeforge/pull/15835

## Do Not Translate (Locale Additions)

- `CodeForge` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `codeforge` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `CodeForge` in prose, `codeforge` only for exact technical identifiers
...
- Avoid changing `codeforge` to `CodeForge` inside commands, URLs, package names, or code literals

...
- PR #13942: https://github.com/YOUR_ORG/codeforge/pull/13942

## Do Not Translate (Locale Additions)

- `CodeForge` (preserve casing in prose; keep `codeforge` only when it is part of commands, package names, paths, or code)
- `CodeForge Zen`
- `CodeForge CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `codeforge` in prose when referring to the product name; use `CodeForge`

...
import { tool } from "@codeforge-ai/plugin"
...
This tool searches PRs in the YOUR_ORG/codeforge repository and returns LLM-friendly results including:
- PR number and title
- Author

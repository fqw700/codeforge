    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://YOUR_DOMAIN.ai/docs"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/codeforge"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/YOUR_ORG/codeforge/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/YOUR_ORG/codeforge/issues/new?template=bug_report.yml"),

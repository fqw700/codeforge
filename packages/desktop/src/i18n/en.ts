export const dict = {
  ...
  "desktop.menu.help.documentation": "CodeForge Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "CodeForge CLI binary is missing. Try reinstalling the desktop app.",

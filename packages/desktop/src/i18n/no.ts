export const dict = {
  ...
  "desktop.menu.help.documentation": "CodeForge Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "CodeForge CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",

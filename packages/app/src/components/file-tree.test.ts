...
beforeAll(async () => {
  ...
  mock.module("@codeforge-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@codeforge-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@codeforge-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@codeforge-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

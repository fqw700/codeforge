...
import { base64Encode } from "@codeforge-ai/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@codeforge-ai/ui/resize-handle"
...
import { getFilename } from "@codeforge-ai/util/path"
import { Session, type Message } from "@codeforge-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@codeforge-ai/ui/toast"
...
import { retry } from "@codeforge-ai/util/retry"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://YOUR_DOMAIN.ai/desktop-feedback")}
      renderPanel={() =>

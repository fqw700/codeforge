export const dict = {
  ...
  "dialog.provider.codeforge.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.codeforge.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.codeforgeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo CodeForge",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CodeForge.",
  ...
  "provider.connect.codeforgeZen.line1":
    "CodeForge Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.codeforgeZen.visit.prefix": "Visite ",
  "provider.connect.codeforgeZen.visit.link": "codeforge.ai/zen",
  "provider.connect.codeforgeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CodeForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CodeForge.",
  ...
  "dialog.plugins.empty": "Plugins configurados em codeforge.json",
  ...
  "dialog.server.description": "Trocar para qual servidor CodeForge este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do CodeForge ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CodeForge",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (codeforge.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CodeForge ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "CodeForge inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CodeForge dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CodeForge",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o CodeForge aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o CodeForge segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CodeForge é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CodeForge iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CodeForge.",

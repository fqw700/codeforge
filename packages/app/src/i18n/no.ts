...
export const dict = {
  ...
  "dialog.provider.codeforge.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.codeforge.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.codeforgeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av CodeForge",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i CodeForge.",
  ...
  "provider.connect.codeforgeZen.line1":
    "CodeForge Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.codeforgeZen.visit.prefix": "Besøk ",
  "provider.connect.codeforgeZen.visit.link": "codeforge.ai/zen",
  "provider.connect.codeforgeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CodeForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CodeForge.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i codeforge.json",
  ...
  "dialog.server.description": "Bytt hvilken CodeForge-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CodeForge ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CodeForge-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (codeforge.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at CodeForge ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "CodeForge inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør CodeForge-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CodeForge",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CodeForge ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om CodeForge skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan CodeForge er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CodeForge starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CodeForge.",

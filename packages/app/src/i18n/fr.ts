export const dict = {
  ...
  "dialog.provider.codeforge.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.codeforge.tagline": "Modèles optimisés et fiables",
  "dialog.provider.codeforgeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par CodeForge",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans CodeForge.",
  ...
  "provider.connect.codeforgeZen.line1":
    "CodeForge Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  "provider.connect.codeforgeZen.line2":
    "Avec une seule clé API, vous aurez accès à des modèles tels que Claude, GPT, Gemini, GLM et plus encore.",
  "provider.connect.codeforgeZen.visit.prefix": "Visitez ",
  "provider.connect.codeforgeZen.visit.link": "codeforge.ai/zen",
  "provider.connect.codeforgeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans CodeForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans CodeForge.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans codeforge.json",
  ...
  "dialog.server.description": "Changez le serveur CodeForge auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'CodeForge ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe CodeForge",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (codeforge.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'CodeForge ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "CodeForge inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "CodeForge Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur CodeForge dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour CodeForge",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'CodeForge sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si CodeForge suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'CodeForge.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'CodeForge",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'CodeForge.",

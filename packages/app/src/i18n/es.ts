export const dict = {
  ...
  "dialog.provider.codeforge.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.codeforge.tagline": "Modelos optimizados y fiables",
  "dialog.provider.codeforgeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por CodeForge",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en CodeForge.",
  ...
  "provider.connect.codeforgeZen.line1":
    "CodeForge Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.codeforgeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.codeforgeZen.visit.prefix": "Visita ",
  "provider.connect.codeforgeZen.visit.link": "codeforge.ai/zen",
  "provider.connect.codeforgeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en CodeForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en CodeForge.",
  ...
  "dialog.plugins.empty": "Plugins configurados en codeforge.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de CodeForge se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de CodeForge ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de CodeForge",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (codeforge.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, CodeForge no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "CodeForge incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor CodeForge dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para CodeForge",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve CodeForge en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si CodeForge sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de CodeForge.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CodeForge",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CodeForge.",

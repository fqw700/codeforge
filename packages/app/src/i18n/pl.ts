export const dict = {
  ...
  "dialog.provider.codeforge.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.codeforge.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.codeforgeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CodeForge",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CodeForge.",
  ...
  "provider.connect.codeforgeZen.line1":
    "CodeForge Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.codeforgeZen.visit.prefix": "Odwiedź ",
  "provider.connect.codeforgeZen.visit.link": "codeforge.ai/zen",
  "provider.connect.codeforgeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CodeForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CodeForge.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w codeforge.json",
  ...
  "dialog.server.description": "Przełącz serwer CodeForge, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja CodeForge ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CodeForge",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (codeforge.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "CodeForge zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CodeForge",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd CodeForge na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CodeForge ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CodeForge.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CodeForge",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CodeForge.",

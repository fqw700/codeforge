export const dict = {
  ...
  "dialog.provider.codeforge.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.codeforge.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.codeforgeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje CodeForge",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CodeForge-u.",
  ...
  "provider.connect.codeforgeZen.line1":
    "CodeForge Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.codeforgeZen.visit.prefix": "Posjeti ",
  "provider.connect.codeforgeZen.visit.link": "codeforge.ai/zen",
  "provider.connect.codeforgeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CodeForge-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CodeForge-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u codeforge.json",
  ...
  "dialog.server.description": "Promijeni na koji se CodeForge server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija CodeForge-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CodeForge timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (codeforge.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CodeForge još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CodeForge uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni CodeForge server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CodeForge-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako CodeForge izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li CodeForge prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CodeForge-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CodeForge pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CodeForge-a.",

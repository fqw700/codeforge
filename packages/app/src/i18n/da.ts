export const dict = {
  ...
  "dialog.provider.codeforge.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.codeforge.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.codeforgeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CodeForge",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i CodeForge.",
  ...
  "provider.connect.codeforgeZen.line1":
    "CodeForge Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.codeforgeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.codeforgeZen.visit.prefix": "Besøg ",
  "provider.connect.codeforgeZen.visit.link": "codeforge.ai/zen",
  "provider.connect.codeforgeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i CodeForge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i CodeForge.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i codeforge.json",
  ...
  "dialog.server.description": "Skift hvilken CodeForge-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af CodeForge ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CodeForge-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (codeforge.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CodeForge understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CodeForge inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør CodeForge-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CodeForge",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan CodeForge ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om CodeForge følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan CodeForge er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CodeForge starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CodeForge.",

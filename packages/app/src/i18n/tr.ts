...
export const dict = {
  ...
  "dialog.provider.codeforge.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.codeforge.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.codeforgeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "CodeForge tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve CodeForge'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.codeforgeZen.line1":
    "CodeForge Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.codeforgeZen.visit.prefix": "",
  "provider.connect.codeforgeZen.visit.link": "codeforge.ai/zen",
  "provider.connect.codeforgeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve CodeForge'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak CodeForge'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler codeforge.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi CodeForge sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "CodeForge'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CodeForge ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (codeforge.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: CodeForge henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "CodeForge ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "CodeForge Masaüstü",
  ...
  "settings.desktop.wsl.description": "CodeForge sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "CodeForge'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "CodeForge'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "CodeForge'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "CodeForge'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "CodeForge başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "CodeForge'un en son sürümünü kullanıyorsunuz.",

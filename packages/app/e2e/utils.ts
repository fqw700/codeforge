import { createOpencodeClient } from "@codeforge-ai/sdk/v2/client"
import { base64Encode, checksum } from "@codeforge-ai/util/encode"
...
export function workspacePersistKey(directory: string, key: string) {
  ...
  return `codeforge.workspace.${head}.${sum}.dat:workspace:${key}`
}

...
import desktopAppIcon from "../../asset/lander/codeforge-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://YOUR_DOMAIN.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>codeforge.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g codeforge-ai")}>
                <code>
                  npm i -g <strong>codeforge-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g codeforge-ai")}>
                <code>
                  bun add -g <strong>codeforge-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/codeforge")}>
                <code>
                  brew install <strong>anomalyco/tap/codeforge</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S codeforge")}>
                <code>
                  paru -S <strong>codeforge</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask codeforge-desktop")}>
                <code>
                  brew install --cask <strong>codeforge-desktop</strong>
                </code>
                <CopyStatus />
              </button>

...
import { and, Database, eq, isNull, lt, or, sql } from "@codeforge-ai/console-core/drizzle/index.js"
import { KeyTable } from "@codeforge-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@codeforge-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@codeforge-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@codeforge-ai/console-core/util/date.js"
import { Identifier } from "@codeforge-ai/console-core/identifier.js"
import { Billing } from "@codeforge-ai/console-core/billing.js"
import { Actor } from "@codeforge-ai/console-core/actor.js"
import { WorkspaceTable } from "@codeforge-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@codeforge-ai/console-core/model.js"
import { Subscription } from "@codeforge-ai/console-core/subscription.js"
import { BlackData } from "@codeforge-ai/console-core/black.js"
import { UserTable } from "@codeforge-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@codeforge-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@codeforge-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@codeforge-ai/console-core/lite.js"
import { Resource } from "@codeforge-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-codeforge-session") ?? ""
    const requestId = input.request.headers.get("x-codeforge-request") ?? ""
    const projectId = input.request.headers.get("x-codeforge-project") ?? ""
    const ocClient = input.request.headers.get("x-codeforge-client") ?? ""
    logger.metric({
      is_stream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-codeforge-request")
          headers.delete("x-codeforge-session")
          headers.delete("x-codeforge-project")
          headers.delete("x-codeforge-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://YOUR_DOMAIN.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://YOUR_DOMAIN.ai/workspace/${authInfo.workspaceID}/members`

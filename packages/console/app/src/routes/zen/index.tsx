...
import compareVideo from "../../asset/lander/codeforge-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/codeforge-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="codeforge:auth" content={loggedin() ? "true" : "false"} />

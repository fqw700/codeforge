import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@codeforge-ai/sdk/v2"
import { SessionTurn } from "@codeforge-ai/ui/session-turn"
import { SessionReview } from "@codeforge-ai/ui/session-review"
import { DataProvider } from "@codeforge-ai/ui/context"
import { FileComponentProvider } from "@codeforge-ai/ui/context/file"
import { WorkerPoolProvider } from "@codeforge-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@codeforge-ai/ui/logo"
import { IconButton } from "@codeforge-ai/ui/icon-button"
import { ProviderIcon } from "@codeforge-ai/ui/provider-icon"
import { iife } from "@codeforge-ai/util/iife"
import { Binary } from "@codeforge-ai/util/binary"
import { NamedError } from "@codeforge-ai/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@codeforge-ai/ui/tabs"
import { MessageNav } from "@codeforge-ai/ui/message-nav"
import { FileSSR } from "@codeforge-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@codeforge-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/codeforge-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | CodeForge</Title>
              </Show>
              <Meta name="description" content="codeforge - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/YOUR_ORG/codeforge"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://YOUR_DOMAIN.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />

...
/**
 * Server configuration for codeforge serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: codeforge.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://YOUR_DOMAIN.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://YOUR_DOMAIN.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig

...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codeforge.git")).toEqual({ owner: "sst", repo: "codeforge" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codeforge")).toEqual({ owner: "sst", repo: "codeforge" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codeforge.git")).toEqual({ owner: "sst", repo: "codeforge" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codeforge")).toEqual({ owner: "sst", repo: "codeforge" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codeforge.git")).toEqual({ owner: "sst", repo: "codeforge" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codeforge")).toEqual({ owner: "sst", repo: "codeforge" })
})

...
Practical reference for new and migrated Effect code in `packages/codeforge`.
...
export namespace Foo {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@codeforge/Foo") {}

...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@codeforge-ai/plugin"
import z from "zod"
...
export namespace ToolRegistry {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@codeforge/ToolRegistry") {}
      ...
      const tools = Effect.fn("ToolRegistry.tools")(function* (
        ...
        const filtered = allTools.filter((tool) => {
          if (tool.id === "codesearch" || tool.id === "websearch") {
            return model.providerID === ProviderID.codeforge || Flag.OPENCODE_ENABLE_EXA
          }

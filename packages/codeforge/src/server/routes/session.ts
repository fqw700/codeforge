  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all CodeForge sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific CodeForge session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new CodeForge session for interacting with AI assistants and managing conversations.",

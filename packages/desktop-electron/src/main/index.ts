...
app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "CodeForge Dev")
app.setPath("userData", join(app.getPath("appData"), app.isPackaged ? APP_IDS[CHANNEL] : "ai.codeforge.desktop.dev"))
...
function setupApp() {
  ...
  app.on("second-instance", (_event: Event, argv: string[]) => {
    const urls = argv.filter((arg: string) => arg.startsWith("codeforge://"))
    if (urls.length) {
...
function sqliteFileExists() {
  ...
  return existsSync(join(base, "codeforge", "codeforge.db"))
}

...
import "./styles.css"
import { useTheme } from "@codeforge-ai/ui/theme"
...
const deepLinkEvent = "codeforge:deep-link"
  ...
  return {
    ...
    notify: async (title, description, href) => {
      ...
      const notification = new Notification(title, {
        body: description ?? "",
        icon: "https://YOUR_DOMAIN.ai/favicon-96x96-v3.png",
      })
...
render(() => {
  ...
  const loadLocale = async () => {
    const current = await platform.storage?.("codeforge.global.dat").getItem("language")

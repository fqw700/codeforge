---
title: TUI
description: Usando la interfaz de usuario del terminal CodeForge.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodeForge proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar CodeForge se inicia TUI para el directorio actual.
...
Cuando utilice CodeForge TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a CodeForge. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de CodeForge. _Alias_: `/quit`, `/q`
...
Esto es independiente de `codeforge.json`, que configura el comportamiento del servidor/tiempo de ejecución.

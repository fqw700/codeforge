...
:::caution
Los modos ahora se configuran a través de la opción `agent` en la configuración codeforge. El
La opción `mode` ahora está en desuso. [Más información](/docs/agents).
:::

Los modos en codeforge le permiten personalizar el comportamiento, las herramientas y las indicaciones para diferentes casos de uso.

Viene con dos modos integrados: **construir** y **planificar**. Puedes personalizar
estos o configure el suyo propio a través de la configuración codeforge.
...
codeforge viene con dos modos integrados.
...
- `edit` - No se pueden modificar archivos existentes, excepto los archivos ubicados en `.codeforge/plans/*.md` para detallar el plan en sí.
...
Configure los modos en su archivo de configuración `codeforge.json`:
...
tanto la configuración global codeforge como la configuración específica del proyecto.
...
Cree archivos de modo en `.codeforge/modes/` para modos específicos del proyecto o `~/.config/codeforge/modes/` para modos globales:

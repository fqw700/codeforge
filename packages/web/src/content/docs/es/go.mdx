...
CodeForge Go es una suscripción de bajo costo — **$5 por tu primer mes**, luego **$10/mes** — que te brinda acceso confiable a modelos abiertos de programación populares.

:::note
CodeForge Go está actualmente en beta.
:::

Go funciona como cualquier otro proveedor en CodeForge. Te suscribes a CodeForge Go y
...
CodeForge Go te da acceso a estos modelos por **$5 por tu primer mes**, luego **$10/mes**.

---

## Cómo funciona

CodeForge Go funciona como cualquier otro proveedor en CodeForge.

1. Inicias sesión en **<a href={console}>CodeForge Zen</a>**, te suscribes a Go y
   copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas `CodeForge Go` y pegas
   tu API key.
3. Ejecutas `/models` en la TUI para ver la lista de modelos disponibles a través de Go.

:::note
Solo un miembro por espacio de trabajo puede suscribirse a CodeForge Go.
:::
...
CodeForge Go incluye los siguientes límites:
...
El [ID del modelo](/docs/config/#models) en tu configuración de CodeForge
usa el formato `codeforge-go/<model-id>`. Por ejemplo, para Kimi K2.5, usarías
`codeforge-go/kimi-k2.5` en tu configuración.
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con CodeForge.

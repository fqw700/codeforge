...
Crear `.codeforge/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración CodeForge o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su CodeForge [config](/docs/config):
...
- Por proyecto: `.codeforge/commands/`
...
codeforge incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).

---
title: Zen
description: Lista seleccionada de modelos proporcionada por CodeForge.
---
...
CodeForge Zen es una lista de modelos probados y verificados proporcionada por el equipo CodeForge.

:::note
CodeForge Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en CodeForge. Inicias sesion en CodeForge Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar CodeForge.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con CodeForge.
:::
...
CodeForge Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

CodeForge Zen funciona como cualquier otro proveedor en CodeForge.

1. Inicias sesión en **<a href={console}>CodeForge Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona CodeForge Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de CodeForge
usa el formato `codeforge/<model-id>`. Por ejemplo, para GPT 5.2 Codex, debes
usar `codeforge/gpt-5.2-codex` en tu configuracion.
...
- MiniMax M2.5 Free está disponible en CodeForge por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en CodeForge por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con CodeForge también.

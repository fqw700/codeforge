...
สร้าง `.codeforge/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ CodeForge:
...
- ระดับผู้ใช้ (Global): `~/.config/codeforge/commands/`
- ระดับโปรเจ็กต์: `.codeforge/commands/`
...
CodeForge มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)

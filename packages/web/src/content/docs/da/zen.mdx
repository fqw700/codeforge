---
title: Zen
description: Udvalgt liste over modeller leveret af CodeForge.
---
...
CodeForge Zen er en liste over testede og verificerede modeller leveret af CodeForge-teamet.

:::note
CodeForge Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i CodeForge. Du logger på CodeForge Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med CodeForge.
:::
...
CodeForge Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

CodeForge Zen fungerer som alle andre udbydere i CodeForge.

1. Du logger på **<a href={console}>CodeForge Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger CodeForge Zen og indsætter API-nøglen.
...
| MiniMax M2.5 Gratis | minimax-m2.5-free  | `https://YOUR_DOMAIN.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Kimi K2 Tenker      | kimi-k2-thinking   | `https://YOUR_DOMAIN.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2             | kimi-k2            | `https://YOUR_DOMAIN.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3-koder 480B    | qwen3-coder        | `https://YOUR_DOMAIN.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Stor sylteagurk     | big-pickle         | `https://YOUR_DOMAIN.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

[model-id](/docs/config/#models) i CodeForge-konfigurationen
bruger formatet `codeforge/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `codeforge/gpt-5.2-codex` i din konfiguration.
...
- MiniMax M2.5 Gratis er tilgængelig på CodeForge i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på CodeForge i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede CodeForge Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med CodeForge også.

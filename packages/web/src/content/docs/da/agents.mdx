...
Der er to typer agenter i CodeForge; primære agenter og subagenter.
...
CodeForge leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
CodeForge leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

CodeForge leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `codeforge.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger CodeForge modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale CodeForge-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din CodeForge-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [CodeForge Zen](/docs/zen), vil du bruge `codeforge/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `codeforge models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/YOUR_ORG/codeforge).
:::

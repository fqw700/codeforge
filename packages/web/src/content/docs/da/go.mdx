...
CodeForge Go er et lavprisabonnement — **$5 for din første måned**, derefter **$10/måned** — der giver dig pålidelig adgang til populære åbne kodningsmodeller.

:::note
CodeForge Go er i øjeblikket i beta.
:::

Go fungerer som enhver anden udbyder i CodeForge. Du abonnerer på CodeForge Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med CodeForge.
:::
...
CodeForge Go giver dig adgang til disse modeller for **$5 for din første måned**, derefter **$10/måned**.

---

## Sådan fungerer det

CodeForge Go fungerer som enhver anden udbyder i CodeForge.

1. Du logger ind på **<a href={console}>CodeForge Zen</a>**, abonnerer på Go, og
   kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `CodeForge Go`, og indsætter
   din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over tilgængelige modeller gennem Go.

:::note
Kun ét medlem per arbejdsområde kan abonnere på CodeForge Go.
:::
...
CodeForge Go inkluderer følgende grænser:
...
Dit [model id](/docs/config/#models) i din CodeForge config
bruger formatet `codeforge-go/<model-id>`. For eksempel for Kimi K2.5, vil du
bruge `codeforge-go/kimi-k2.5` i din config.
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med CodeForge.

---
title: TUI
description: Brug af CodeForge-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodeForge giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre CodeForge starter TUI for den nuværende mappe.
...
Når du bruger CodeForge TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til CodeForge. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut CodeForge. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `codeforge.json`, som konfigurerer server-/kørselstidsadfærd.

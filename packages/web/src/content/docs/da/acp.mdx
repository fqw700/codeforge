...
description: Brug CodeForge i enhver ACP-kompatibel editor.
---

CodeForge understøtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), så du kan bruge det direkte i kompatible editorer og IDE'er.
...
For at bruge CodeForge via ACP, konfigurer din editor til at køre kommandoen `codeforge acp`.

Kommandoen starter CodeForge som en ACP-kompatibel underproces, der kommunikerer med din editor over JSON-RPC via stdio.
...
For at åbne den skal du bruge den nye 'CodeForge'-agent i AI Chat-agentvælgeren.
...
For at bruge CodeForge som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge CodeForge som ACP-agent til chat.
...
CodeForge fungerer på samme måde via ACP som i terminalen. Alle funktioner understøtter:
...
- MCP-servere konfigureret i din CodeForge-konfiguration

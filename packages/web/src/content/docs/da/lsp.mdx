---
title: LSP-servere
description: CodeForge integreres med dine LSP-servere.
---

CodeForge integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

CodeForge leveres med flere indbyggede LSP-servere til populære sprog:
...
Når codeforge åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din codeforge-konfiguration.

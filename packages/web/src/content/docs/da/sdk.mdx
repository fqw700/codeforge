...
Brug den til at bygge integrasjoner og kontrollere codeforge programmatisk.
...
Opret en forekomst av codeforge:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `codeforge.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av codeforge, kan du oprete en klientforekomst for at koble til den:

---
title: Suporte ACP
description: Use o codeforge em qualquer editor compatível com ACP.
---

O codeforge suporta o [Agent Client Protocol](https://agentclientprotocol.com) ou (ACP), permitindo que você o utilize diretamente em editores e IDEs compatíveis.
...
Para usar codeforge via ACP, configure seu editor para executar o comando `codeforge acp`.

Este comando inicia o codeforge como um subprocesso compatível com ACP que se comunica com seu editor via JSON-RPC através do stdio.
...
Para abri-lo, use o novo agente 'codeforge' no seletor de agentes do AI Chat.
...
Para usar codeforge como um agente ACP no [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), adicione o seguinte à sua configuração do Neovim:
...
Esta configuração configura o CodeCompanion para usar codeforge como o agente ACP para chat.
...
O codeforge funciona da mesma forma via ACP como funciona no terminal. Todos os recursos são suportados:
...
- Servidores MCP configurados na sua configuração do codeforge

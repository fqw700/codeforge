---
title: TUI
description: Usando a interface de usuário de terminal codeforge.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O codeforge fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar codeforge inicia o TUI para o diretório atual.
...
Ao usar o TUI do codeforge, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao codeforge. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do codeforge. _Aliases_: `/quit`, `/q`
...
Isso é separado do `codeforge.json`, que configura o comportamento do servidor/runtime.

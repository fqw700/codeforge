...
O CodeForge Go é uma assinatura de baixo custo — **US$ 5 no seu primeiro mês**, depois **US$ 10/mês** — que oferece acesso confiável a modelos abertos de programação populares.

:::note
O CodeForge Go está atualmente em beta.
:::

O Go funciona como qualquer outro provedor no CodeForge. Você assina o CodeForge Go e
...
O CodeForge Go lhe dá acesso a esses modelos por **US$ 5 no seu primeiro mês**, depois **US$ 10/mês**.

---

## Como funciona

O CodeForge Go funciona como qualquer outro provedor no CodeForge.

1. Você entra no **<a href={console}>CodeForge Zen</a>**, assina o Go e
   copia a sua chave de API.
2. Você executa o comando `/connect` na TUI, seleciona `CodeForge Go` e cola
   a sua chave de API.
3. Execute `/models` na TUI para ver a lista de modelos disponíveis através do Go.

:::note
Apenas um membro por workspace pode assinar o CodeForge Go.
:::
...
O CodeForge Go inclui os seguintes limites:
...
O [ID do modelo](/docs/config/#models) na sua configuração do CodeForge
usa o formato `codeforge-go/<model-id>`. Por exemplo, para o Kimi K2.5, você usaria
`codeforge-go/kimi-k2.5` na sua configuração.
...
4. Não ter **nenhuma restrição de fornecedor (lock-in)**, permitindo que você use qualquer outro provedor com o CodeForge também.

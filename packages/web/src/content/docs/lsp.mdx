---
title: LSP Servers
description: CodeForge integrates with your LSP servers.
---

CodeForge integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

CodeForge comes with several built-in LSP servers for popular languages:
...
When codeforge opens a file, it:
...
You can customize LSP servers through the `lsp` section in your codeforge config.

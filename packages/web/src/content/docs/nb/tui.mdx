---
title: TUI
description: Bruke codeforge-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodeForge gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre CodeForge starter TUI for gjeldende katalog.
...
Når du bruker CodeForge TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til CodeForge. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt CodeForge. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `codeforge.json`, som konfigurerer server-/kjøretidsoppførsel.

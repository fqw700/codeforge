---
title: Zen
description: Utvalgt liste over modeller levert av CodeForge.
---
...
CodeForge Zen er en liste over testede og verifiserte modeller levert av CodeForge-teamet.

:::note
CodeForge Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i CodeForge. Du logger på CodeForge Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med CodeForge.
:::
...
CodeForge Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

CodeForge Zen fungerer som alle andre leverandører i CodeForge.

1. Du logger på **<a href={console}>CodeForge Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger CodeForge Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i CodeForge-konfigurasjonen
bruker formatet `codeforge/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `codeforge/gpt-5.2-codex` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på CodeForge i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på CodeForge i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
Vi opprettet CodeForge Zen for å:
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med CodeForge også.

...
Opprett `.codeforge/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom CodeForge-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i CodeForge [config](/docs/config):
...
- Per prosjekt: `.codeforge/commands/`
...
CodeForge inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).

...
Agentferdigheter lar CodeForge oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går codeforge opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
codeforge viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `codeforge.json`:

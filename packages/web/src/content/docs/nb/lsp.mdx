---
title: LSP-servere
description: codeforge integreres med LSP-serverne dine.
---

CodeForge integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

CodeForge kommer med flere innebygde LSP-servere for populære språk:
...
Når codeforge åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i CodeForge-konfigurasjonen.

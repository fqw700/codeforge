...
description: Lag verktøy som LLM kan kalle inn CodeForge.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med CodeForge sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.codeforge/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/codeforge/tools/`.

...
CodeForge Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
CodeForge Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i CodeForge. Du abonnerer på CodeForge Go og
...
CodeForge Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

CodeForge Go fungerer som enhver annen leverandør i CodeForge.

1. Du logger inn på **<a href={console}>CodeForge Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `CodeForge Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på CodeForge Go.
:::
...
CodeForge Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din CodeForge-konfigurasjon
bruker formatet `codeforge-go/<model-id>`. For eksempel, for Kimi K2.5, vil du
bruke `codeforge-go/kimi-k2.5` i konfigurasjonen din.
...
Vi opprettet CodeForge Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med CodeForge også.

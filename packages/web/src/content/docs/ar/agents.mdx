...
يوجد نوعان من الوكلاء في CodeForge: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي CodeForge مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي CodeForge مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي CodeForge مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `codeforge.json`:
...
- عام: `~/.config/codeforge/agents/`
- لكل مشروع: `.codeforge/agents/`
...
إذا لم يتم تحديد temperature، يستخدم CodeForge القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات CodeForge العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات CodeForge الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [CodeForge Zen](/docs/zen)، فستستخدم `codeforge/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `codeforge models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/YOUR_ORG/codeforge).
:::

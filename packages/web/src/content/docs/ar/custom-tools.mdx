...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في codeforge.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في codeforge مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.codeforge/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/codeforge/tools/`.

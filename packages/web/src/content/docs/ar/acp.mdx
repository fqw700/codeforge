---
title: دعم ACP
description: استخدم CodeForge في أي محرر متوافق مع ACP.
---

يدعم CodeForge بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام CodeForge عبر ACP، اضبط محررك ليشغّل الأمر `codeforge acp`.

يشغّل هذا الأمر CodeForge كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'CodeForge' من محدد الوكلاء في AI Chat.
...
لاستخدام CodeForge كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام CodeForge كوكيل ACP للدردشة.
...
يعمل CodeForge عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات CodeForge

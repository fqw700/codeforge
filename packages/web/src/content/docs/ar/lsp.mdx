---
title: خوادم LSP
description: يتكامل CodeForge مع خوادم LSP لديك.
---

يتكامل CodeForge مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي CodeForge مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عندما يفتح codeforge ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات codeforge.

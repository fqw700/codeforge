...
Utwórz `.codeforge/commands/test.md`:
...
Możesz zdefiniować polecenia w `codeforge.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji codeforge:
...
- Globalnie: `~/.config/codeforge/commands/`
- Na projekt: `.codeforge/commands/`
...
codeforge zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).

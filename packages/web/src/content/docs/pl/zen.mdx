---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez CodeForge.
---
...
CodeForge Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół CodeForge.

:::note
CodeForge Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w CodeForge. Logujesz się do CodeForge Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z CodeForge.
:::
...
CodeForge Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

CodeForge Zen działa jak każdy inny dostawca w CodeForge.

1. Logujesz się do **<a href={console}>CodeForge Zen</a>**, dodajesz dane rozliczeniowe
   i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz CodeForge Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji CodeForge
używa formatu `codeforge/<model-id>`. Na przykład w przypadku GPT 5.2 Codex użyłbyś
`codeforge/gpt-5.2-codex` w swojej konfiguracji.
...
- MiniMax M2.5 Free jest dostępny w CodeForge przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w CodeForge przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
Stworzyliśmy CodeForge Zen, aby:
...
4. Nie **mieć blokady** (no lock-in), umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalać na korzystanie z dowolnego innego dostawcy w CodeForge.

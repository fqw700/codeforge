---
title: SDK
description: Typowany klient JS dla serwera CodeForge.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS CodeForge zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli CodeForge.
...
Można przekazać obiekt konfiguracyjny, aby dostosować zachowanie. Instancja nadal pobiera `codeforge.json`, ale możesz zastąpić lub dodać konfigurację bezpośrednio:
...
Jeśli masz już działającą instancję CodeForge, możesz utworzyć instancję klienta, aby się z nią połączyć:

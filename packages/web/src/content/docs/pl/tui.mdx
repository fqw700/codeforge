---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala codeforge.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

codeforge zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie codeforge uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI codeforge, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do codeforge. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij codeforge. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `codeforge.json`, który konfiguruje zachowanie serwera/runtime.

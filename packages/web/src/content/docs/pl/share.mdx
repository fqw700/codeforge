---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące codeforge.
---

Funkcja udostępniania codeforge umożliwia tworzenie publicznych linków do konwersacji codeforge, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, codeforge:
...
codeforge obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie codeforge korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `codeforge.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu codeforge w Twojej organizacji.

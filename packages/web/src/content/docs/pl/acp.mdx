---
title: ACP
description: Używanie CodeForge z protokołem Agent Client Protocol (ACP).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodeForge obsługuje [Agent Client Protocol](https://agentclientprotocol.com) (ACP), który umożliwia korzystanie z CodeForge bezpośrednio w edytorach i środowiskach IDE.
...
Aby używać CodeForge przez ACP, skonfiguruj swój edytor tak, aby uruchamiał polecenie `codeforge acp`.

Uruchamia to CodeForge jako podproces zgodny z ACP, który komunikuje się z edytorem za pomocą JSON-RPC przez stdio.
...
Następnie wybierz „CodeForge” w selektorze agentów AI Chat.
...
Aby używać CodeForge jako agenta ACP w [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodaj następującą konfigurację do Neovim:
...
Ta konfiguracja sprawia, że CodeCompanion używa CodeForge jako agenta ACP do czatu.
...
CodeForge działa przez ACP tak samo, jak w terminalu. Obsługiwane są wszystkie główne funkcje:
...
- Serwery MCP zdefiniowane w konfiguracji CodeForge

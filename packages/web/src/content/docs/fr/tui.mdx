---
title: TUI
description: Utilisation de l’interface utilisateur du terminal CodeForge.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodeForge fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de CodeForge démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le CodeForge TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à CodeForge. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez CodeForge. *Alias* : `/quit`, `/q`
...
Ceci est séparé de `codeforge.json`, qui configure le comportement du serveur/d'exécution.

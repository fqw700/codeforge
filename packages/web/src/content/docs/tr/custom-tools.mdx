---
title: Özel Araçlar
description: LLM'un codeforge'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. codeforge'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.codeforge/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/codeforge/tools/` içine yerleştirerek.

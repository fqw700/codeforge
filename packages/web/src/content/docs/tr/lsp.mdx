...
description: CodeForge, LSP sunucularınızla bütünleşir.
---

CodeForge, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

CodeForge, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
codeforge bir dosyayı açtığında:
...
LSP sunucularını, codeforge yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.

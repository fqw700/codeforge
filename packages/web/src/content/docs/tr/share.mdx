---
title: Paylasim
description: codeforge konusmalarini genel baglantilarla paylasin.
---

codeforge'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda codeforge:
...
codeforge, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak codeforge manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `codeforge.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda codeforge kullanimi icin [daha fazla bilgi alin](/docs/enterprise).

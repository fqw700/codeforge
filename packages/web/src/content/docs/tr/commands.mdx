...
`.codeforge/commands/test.md` oluştur:
...
codeforge işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

codeforge [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/codeforge/commands/`
- Proje başına: `.codeforge/commands/`
...
codeforge, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).

---
title: LSP Server
description: CodeForge lässt sich in Ihren LSP-Server integrieren.
---

CodeForge lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

CodeForge verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn CodeForge eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer CodeForge-Konfiguration anpassen.

...
Erstellen Sie `.codeforge/commands/test.md`:

```md title=".codeforge/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die CodeForge-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem CodeForge [config](/docs/config):

```json title="codeforge.jsonc" {4-12}
{
...
- Global: `~/.config/codeforge/commands/`
- Pro Projekt: `.codeforge/commands/`

```markdown title="~/.config/codeforge/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".codeforge/commands/component.md"
---
...
```md title=".codeforge/commands/create-file.md"
---
...
```md title=".codeforge/commands/analyze-coverage.md"
---
...
```md title=".codeforge/commands/review-changes.md"
---
...
```md title=".codeforge/commands/review-component.md"
---
...
CodeForge enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).

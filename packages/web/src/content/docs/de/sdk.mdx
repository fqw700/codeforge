---
title: SDK
description: Typsicherer JS-Client fuer den codeforge-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das codeforge JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und codeforge programmatisch steuern.
...
Erstelle eine codeforge-Instanz:
...
`codeforge.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn codeforge bereits laeuft, kannst du nur einen Client erstellen und verbinden:

---
title: Teilen
description: Teile CodeForge-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu CodeForge-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht CodeForge Folgendes:
...
CodeForge hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt CodeForge den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`codeforge.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du codeforge in deiner Organisation einsetzt.

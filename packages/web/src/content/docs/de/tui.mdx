---
title: TUI
description: Arbeite mit CodeForge in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodeForge bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet CodeForge die TUI im aktuellen Verzeichnis.
...
In der CodeForge-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu CodeForge hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet CodeForge. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `codeforge.json`, welche das Server-/Runtime-Verhalten konfiguriert.

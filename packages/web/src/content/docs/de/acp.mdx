...
description: Verwenden Sie CodeForge in jedem ACP-kompatiblen Editor.
---

CodeForge unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um CodeForge über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `codeforge acp`.

Der Befehl startet CodeForge als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „CodeForge“ in der AI Chat Agent Selector.
...
Um CodeForge als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass CodeForge als ACP-Agent für den Chat verwendet wird.
...
CodeForge funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer CodeForge-Konfiguration konfiguriert sind

...
Kreiraj `.codeforge/commands/test.md`:
...
Možete dodati prilagođene komande kroz CodeForge konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom CodeForge [config](/docs/config):
...
- Globalno: `~/.config/codeforge/commands/`
- Po projektu: `.codeforge/commands/`
...
CodeForge uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note

---
title: LSP serveri
description: CodeForge se integriše sa vašim LSP serverima.
---

CodeForge se integriše sa vašim Language Server Protocol (LSP) serverima kako bi pomogao LLM-u u interakciji s kodnom bazom. Koristi dijagnostiku za slanje povratnih informacija modelu.

## Ugrađeni

CodeForge dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
Možete prilagoditi LSP servere kroz `lsp` odjeljak u vašoj codeforge konfiguraciji.

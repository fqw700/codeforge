---
title: ACP podrška
description: Koristite CodeForge u bilo kojem uređivaču kompatibilnom sa ACP.
---

CodeForge podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili CodeForge putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `codeforge acp`.

Naredba pokreće CodeForge kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "CodeForge" agenta u AI Chat agent selektoru.
...
Da koristite CodeForge kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi CodeForge kao ACP chat agenta.
...
CodeForge radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj CodeForge konfiguraciji

---
title: TUI
description: Korištenje korisničkog interfejsa CodeForge terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CodeForge pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje CodeForge pokreće TUI za trenutni direktorij.
...
Kada koristite CodeForge TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u CodeForge. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz CodeForge. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `codeforge.json`, koji konfiguriše ponašanje servera/izvršavanja.

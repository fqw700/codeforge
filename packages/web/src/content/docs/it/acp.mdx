---
title: Supporto ACP
description: Usa CodeForge in qualunque editor compatibile con ACP.
---

CodeForge supporta [Agent Client Protocol](https://agentclientprotocol.com) (ACP), permettendoti di usarlo direttamente in editor e IDE compatibili.
...
Per usare CodeForge via ACP, configura l'editor in modo che esegua il comando `codeforge acp`.

Il comando avvia CodeForge come sottoprocesso compatibile con ACP che comunica con l'editor via JSON-RPC su stdio.
...
Per aprirlo, seleziona il nuovo agente 'CodeForge' nel selettore agenti di AI Chat.
...
Per usare CodeForge come agente ACP in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), aggiungi quanto segue alla config di Neovim:
...
Questa config imposta CodeCompanion per usare CodeForge come agente ACP per la chat.
...
CodeForge funziona via ACP come nel terminale. Tutte le funzionalita sono supportate:
:::note
...
- Server MCP configurati nella tua configurazione CodeForge

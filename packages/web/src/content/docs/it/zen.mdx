---
title: Zen
description: Lista curata di modelli fornita da CodeForge.
---
...
CodeForge Zen è una lista di modelli testati e verificati dal team di CodeForge.

:::note
CodeForge Zen è attualmente in beta.
:::

Zen funziona come qualunque altro provider in CodeForge. Accedi a CodeForge Zen e ottieni la tua chiave API. È **completamente opzionale** e non devi usarlo per usare CodeForge.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con CodeForge.
:::
...
CodeForge Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

CodeForge Zen funziona come qualunque altro provider in CodeForge.

1. Accedi a **<a href={console}>CodeForge Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona CodeForge Zen e incolla la chiave API.
...
| MiMo V2 Flash Free    | mimo-v2-flash-free    | `https://YOUR_DOMAIN.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Nemotron 3 Super Free | nemotron-3-super-free | `https://YOUR_DOMAIN.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

Il [model id](/docs/config/#models) nella config di CodeForge usa il formato `codeforge/<model-id>`. Per esempio, per GPT 5.3 Codex, useresti `codeforge/gpt-5.3-codex` nella config.
...
- MiniMax M2.5 Free è disponibile su CodeForge per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiMo V2 Flash Free è disponibile su CodeForge per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su CodeForge per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth gratuito su CodeForge per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato CodeForge Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con CodeForge.
